...
class Breakout:
    ...
    def __init__(self):
        ...
        pygame.init()
        pygame.mixer.init()
        pygame.display.set_caption("Breakout - Tópicos Especiais")
        ...
        self.__scenes = (
            PlayingGameScene(self), GameOverScene(self), HighScoreScene(self), MenuScene(self)
        )

        self.__currentScene = int(0)
    ...
    def start(self):
        while 1:
            ...
            currentScene = self.__scenes[0]
            currentScene.handleEvents(pygame.event.get())
            currentScene.render(self)
